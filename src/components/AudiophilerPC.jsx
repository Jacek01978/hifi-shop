...
const CONTENT = {
  de: {
    ...
    components: [
      ...
      { title: 'AudioQuest JitterBug FMJ', icon: '🛡️', desc: 'Der AudioQuest JitterBug FMJ sitzt zwischen dem Mini-PC und dem USB-Audio-Interface. Er filtert parasitäre Resonanzen, Netzrauschen und Störungen auf der USB-Leitung, die sich negativ auf den Klang auswirken. Ein kleines Gerät mit großer Wirkung.' },
  ...
  en: {
    ...
    components: [
      ...
      { title: 'AudioQuest JitterBug FMJ', icon: '🛡️', desc: 'The AudioQuest JitterBug FMJ sits between the mini PC and the USB audio interface. It filters parasitic resonances, mains noise and interference on the USB line that negatively affect the sound. A small device with a big effect.' },
